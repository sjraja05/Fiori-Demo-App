		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori sample",
									"targetURL": "#comrizingadzprojectsample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrizingadzprojectsample-display": {
								"semanticObject": "comrizingadzprojectsample",
								"action": "display",
								"description": "A Fiori sample application.",
								"title": "Fiori sample",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rizing.ad.zprojectsample",
									"url": sap.ui.require.toUrl("com/rizing/ad/zprojectsample")
								}
							}
						}
					}
